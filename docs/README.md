...
> A 3-station automated umbrella drying system powered by **12V DC** — battery-operated, no mains voltage. Uses PTC ceramic heaters (40A automotive relay-switched), BLDC fans with ESC control, and worm gear motors for umbrella rotation. Controlled by Arduino Mega 2560.
...
| [FIRMWARE-GUIDE.md](FIRMWARE-GUIDE.md) | Complete staged Arduino sketch + pin map + wiring table |
...
| [../wiring/README.md](../wiring/README.md) | **Canonical** pin map and all connections |
...
2. **Upload firmware** — See [FIRMWARE-GUIDE.md](FIRMWARE-GUIDE.md). Install libraries, upload staged sketch.
